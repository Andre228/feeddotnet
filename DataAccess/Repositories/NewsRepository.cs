...
namespace DataAccess.Repositories
{
    public class NewsRepository : INewsRepository
    {
        ...
        public async Task<NewsItem> UpdateAsync(NewsItem item, Action<NewsItem>? partialUpdate = null)
        {
            ...
            if (partialUpdate != null)
            {
                ...
                var affectedRows = await _context.NewsItems
                    ...
                    .ExecuteUpdateAsync(setters => setters
                        .SetProperty(n => n.Title, n => !string.IsNullOrEmpty(stub.Title) ? stub.Title : n.Title)
                        .SetProperty(n => n.Description, n => !string.IsNullOrEmpty(stub.Description) ? stub.Description : n.Description)
                        .SetProperty(n => n.ImageUrl, n => !string.IsNullOrEmpty(stub.ImageUrl) ? stub.ImageUrl : n.ImageUrl)
